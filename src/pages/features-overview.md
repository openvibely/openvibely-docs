...
| Agents | Reusable AI worker profiles with prompts, skills, plugins, MCP servers, permissions, routing, lifecycle hooks, and bundled workflow skills. | [Agents](agents.html), [Lifecycle Hooks](lifecycle-hooks.html), [Skill Curation](skills-and-learning.html), [GitHub Autonomous SDLC Skill](github-autonomous-sdlc.html) |
